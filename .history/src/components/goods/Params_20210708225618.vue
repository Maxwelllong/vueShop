...
<template>
    ...
    <el-card>
        ...
        <!-- 修改按钮 -->
        <el-dialog title="修改静态属性" :visible.sync="editDialog" width="50%" @close = 'editFormClosed'>
            <el-form :model="editCateForm" :rules="editCateFormRules" ref="editCateFormRef" label-width="150px" >
                <el-form-item label="修改静态属性" prop="attr_name">
