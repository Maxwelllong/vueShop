...
<template>
    ...
    <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="updatEditform">确 定</el-button>
    </span>
    </el-dialog>
    </div>
</template>
...
export default {
    ...
    methods:{
        ...
        async editGoods(id){
            ...
            if(res.meta.status !== 200 ) return this.$message.warning('商品信息获取失败')
        ...
        updatEditform(){
            ...
            const { data: res } = await this.$http.put(`goods/${this.editForm.cat_id}`);
            console.log(res);
