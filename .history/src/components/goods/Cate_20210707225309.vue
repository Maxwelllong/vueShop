...
<template>
    ...
    <el-dialog title="添加分类" :visible.sync="addCateDialog" width="50%" @close='closedDialog'>
        <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px" refs='addCateForm'>
            <el-form-item label="分类名称" prop="addCateName">
                <el-input v-model="addCateForm.addCatName"></el-input>
            </el-form-item>
        </el-form>
        <span slot="footer"
                class="dialog-footer">
            ...
            <el-button type="primary"
                    @click="addCateDialog = false">确 定</el-button>
        </span>
    </el-dialog>
    </div>
</template>
...
export default {
    data() {
        return{
            ...
            closedDialog(){
                this.$ref.addCateForm.resetFields()
            }
        }
    },
    methods:{
