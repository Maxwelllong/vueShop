                ...
                <el-table :data="onlyParamsList" >
                    ...
                    <el-table-column label="操作" > 
                        <template slot-scope="scope">
                            ...
                            <el-button type="danger"  size='mini' icon="el-icon-delete" @click="deleteEditDialog(scope.row)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-tab-pane>
...
export default {
    ...
    methods:{
        ...
        async deleteEditDialog(item){
            console.log(item);
            const { data: res } = await this.$http.delete(`categories//attributes/:attrid`)
        }
