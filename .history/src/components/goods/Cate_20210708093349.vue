...
export default {
    ...
    methods:{
        ...
        handleChange(){
            ...
            if(!this.selectedOption.length) return this.$message.warning('请选择对应的父节点');
            this.cat_pid = this.selectedOption[this.selectedOption.length -1]
            this.cat_level = this.selectedOption.length
        },
        updataCateDialog(){
