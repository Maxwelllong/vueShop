...
<template>
    <div>
        ...
        width="70%">
            <el-form :model="editeForm" :rules="editeForm_rules" ref="editeForm_ref" label-width="100px">
                <el-form-item label="用户名" >
                    <el-input v-model="editeForm.username" disabled></el-input>
                </el-form-item>
                <el-form-item label="邮箱" >
                    <el-input v-model="editeForm_rules.email" ></el-input>
                </el-form-item>
                <el-form-item label="手机" >
                    <el-input v-model="editeForm_rules.mobile" ></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" >
