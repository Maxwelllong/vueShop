       ...
       <!-- 面包屑导航 -->
        ...
        <el-card>
            ...
            <el-table :data="userInfo" stripe style="width: 100%" border>
                ...
                <el-table-column label="操作" >
                    <template slot-scope="scope">
                        ...
                        <el-button type="warning" icon="el-icon-setting" size="mini" @click="setRight">分配权限</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <!-- 添加角色 -->
            ...
            <el-dialog title="修改权限"  :visible.sync="setRightDialog" width="50%">
               <el-tree :data="setRightForm " show-checkbox node-key="id" :default-expanded-keys="[2, 3]"
...
export default {
    ...
    methods:{
        ...
        setRight(){
            ...
            if(res.meta.status !== 200)  retrun this.$message.Error('数据获取失败');
