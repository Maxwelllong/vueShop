       ...
       <!-- 面包屑导航 -->
        ...
        <el-card>
            ...
            <el-dialog title="修改权限"  :visible.sync="setRightDialog" width="50%">
               <el-tree :data="setRightForm " default-expand-all show-checkbox node-key="id" 
...
export default {
    ...
    methods:{
        ...
        async updataEditForm(){
             const { data: res } = await this.$http.post(`roles/${this.setRightForm.id}/rights`, {
                 this.checkedArr.concat(',')
             })
