        ...
        <el-card>
            ...
            <el-table :data="userInfo" stripe style="width: 100%" border>
                ...
                <el-table-column label="操作" >
                    <template slot-scope="scope">
                        <el-button type="primary" icon="el-icon-edit" size="mini" @click="editRolesInfo(scope.row.roleId)">编辑</el-button>
            ...
            <el-dialog title="提示" :visible.sync="editRoleDialog" width="50%" @click="closeEditForm" >
                ...
                <span slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click="updataEditForm(scope.row.id)">确 定</el-button>
                </span>
            </el-dialog>
        </el-card>
    </div>
        ...
        updataEditForm(id){
            this.$refs.editRolesFormRef.validate(async(valid) => {
                if (valid) {
                   ...
                   if(res.meta.status !== 200 ) return this.$message.warinig('提交失败！')
                   this.editRoleDialog = false;
                   this.getUserInfo();
                   
                } else {
                    this.$message.warining('表单内容不符合要求!!');
                    return false;
                }
            })
        }
