...
<template>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-dialog title="修改地址" @close = 'addressDialogClosed'
            ...
            <el-form :model="addressInfo" :rules="addressInfoRules" ref="addressInfoRef" label-width="100px" >
                <el-form-item label="省市区/县" prop="bigAddress">
                    <el-cascader
                      v-model="addressInfo.bigAddress"
                      :options="citydata" 
                      hover
        ...
        <!-- 展示物流信息 -->
        <el-dialog title="物流信息" :visible.sync="showProgressDialog" width="50%">
            <!-- <el-timeline >
                <el-timeline-item
            ...
            <span slot="footer"
                    class="dialog-footer">
                <el-button @click="showProgressDialog = false">取 消</el-button>
                <el-button type="primary"
                        @click="showProgressDialog = false">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    methods:{
        ...
        async showProgressBox(){
            ...
            if(res.meta.status !== 200 ) return this.$message.warning('获取物流信息失败！')
